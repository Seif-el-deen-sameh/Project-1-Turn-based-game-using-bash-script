...
ghoul_toughness_min=9
ghoul_toughness_max=20

spider_power_min=5
spider_power_max=10

spider_toughness_min=9
spider_toughness_max=20

zombie_power_min=5
zombie_power_max=10

zombie_toughness_min=9
zombie_toughness_max=20

dragon_power_min=5
dragon_power_max=10

dragon_toughness_min=9
dragon_toughness_max=20
...
#echo "Adventurer you chose :$player_action"
echo "====================================================="
